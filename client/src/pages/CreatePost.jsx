...
import { generateRoute, handlePostRoute } from '../utils/APIRoutes';
...
const CreatePost = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(!form.prompt && !form.photo && form.name === ""){
            alert("Please make sure name isn't blank, the prompt is filled and the image is generated");
            return;
        }

        setLoading(true);
        try {
            const response = await fetch(handlePostRoute, {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json',
                },
